...
<div class="workspace-tiles">
    <div class="row">
        <c:forEach var="document" items="${documents}" varStatus="status">
            ...
            <c:choose>
                <c:when test="${status.count % 12 eq 0}"><div class="clearfix"></div></c:when>
                <c:when test="${status.count % 6 eq 0}"><div class="clearfix visible-md-block visible-sm-block"></div></c:when>
                <c:when test="${status.count % 4 eq 0}"><div class="clearfix visible-lg-block visible-sm-block"></div></c:when>
                <c:when test="${status.count % 3 eq 0}"><div class="clearfix visible-md-block"></div></c:when>
                <c:when test="${status.count % 2 eq 0}"><div class="clearfix visible-sm-block"></div></c:when>
            </c:choose>
       </c:forEach>
    </div>
</div>
