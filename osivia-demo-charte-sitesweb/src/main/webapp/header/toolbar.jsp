...
<c:set var="appsLogout"
    value="${requestScope['osivia.demo.customizer.applications']}" />
...
<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <button type="button"
                class="drawer-toggle-btn btn navbar-btn pull-left"
                data-toggle="drawer">
                <i class="glyphicons show_lines"></i> <span class="text">${requestScope['osivia.currentPageName']}</span>
            </button>

            <!-- Toggle navigation menu button -->
            <button type="button" class="btn navbar-btn visible-xs pull-left"
                data-toggle="tabs-menu">
                <i class="glyphicons halflings th"></i>
            </button>

            <!-- Toggle toolbar menu button -->
            <button type="button" class="btn navbar-btn visible-xs"
                data-toggle="collapse" data-target="#toolbar-content">
                <i class="glyphicons halflings cog"></i>
            </button>

            <!-- Search -->
            <form class="navbar-form visible-xs"
                onsubmit="return onsubmitGlobalSearch(this);" method="post"
                role="search">
                <div class="form-group">
                    <label class="sr-only" for="search-toolbar-input">Search</label>
                    <div class="input-group">
                        <input id="search-toolbar-input" type="text" name="keywords"
                            class="form-control"
                            placeholder='<is:getProperty key="SEARCH_PLACEHOLDER" />'>
            ...
            <c:choose>
                <c:when test="${empty requestScope['osivia.toolbar.principal']}">
                    <ul class="nav navbar-nav navbar-right offline">
                        <!-- Login -->
                        <li><a href="${requestScope['osivia.toolbar.loginURL']}"
                            class="navbar-link"> <i class="glyphicons halflings log_in"></i>
